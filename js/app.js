...
function finishGame(){
	if (starsNum == 3){
		document.getElementById('overlay').querySelector("h3").textContent = "Excellent"
		document.getElementById('overlay').querySelector("p").textContent = "Your time was " + min + ":" + sec +" and you won " + starsNum + " Stars"
		
	
	} else if (starsNum == 2){
		document.getElementById('overlay').querySelector("h3").textContent = "Well done"
		document.getElementById('overlay').querySelector("p").textContent = "Your time was " + min + ":" + sec +" and you won " + starsNum + " Stars"
	
	} else if (starsNum == 1){
	
		document.getElementById('overlay').querySelector("h3").textContent = "Nice try"
		document.getElementById('overlay').querySelector("p").textContent = "Your time was " + min + ":" + sec +" and you won " + starsNum + " Star"
		document.getElementById('overlay').querySelector("button").textContent = "Try again"
		...
		if(evt.target.tagName === "LI"){
			...
			if($(".card.open.show").length === 2){
				...
				if ( $(".card.open.show").has(currentCard) ){
					...
					if (anotherCard.querySelector("i").className === currentCard.querySelector("i").className) {
